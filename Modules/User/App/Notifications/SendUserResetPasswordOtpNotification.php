...
class SendUserResetPasswordOtpNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(__('user::app.auth.reset_password_otp.subject'))
            ->markdown('user::emails.user_reset_password_otp', [
                ...
                'websiteName' => 'Ugaros',  // Fetches the application name from config
            ]);
    }
